...
BOOST_AUTO_TEST_CASE(MoneyRangeTest)
{
  ...
  BOOST_CHECK_EUQAL(MoneyRange(CAmount(1)), true);
...
BOOST_AUTO_TEST_CASE(GetFeeTest)
{
  ...
  BOOST_CHECK(CFeeRate(CAmount(2), 1000) == CFeeRate(1));

  BOOST_CHECK(CFeeRate(CAmount(26), 1000) == CFeeRate(32));
  BOOST_CHECK(CFeeRate(CAmount(27), 1000) == CFeeRate(34));
